...
class TestSmokeImports:
    ...
    def test_domain_value_objects_importable(self) -> None:
        from formulation_workbench.domain.value_objects.cas_number import CasNumber
        ...
        from formulation_workbench.domain.value_objects.mass_percent import MassPercent
    ...
    def test_domain_services_importable(self) -> None:
        from formulation_workbench.domain.services.class_ranker import ClassRanker, ClassRanking
        from formulation_workbench.domain.services.verification_rules import VerificationRules
    ...
    def test_domain_events_importable(self) -> None:
        from formulation_workbench.domain.events import (
            RecipeCreated,
            RecipeVerified,
        )
    ...
    def test_application_layer_importable(self) -> None:
        from formulation_workbench.application.ports.audit_logger import AuditLogger
        from formulation_workbench.application.ports.recipe_repository import RecipeRepository
    ...
    def test_infrastructure_db_importable(self) -> None:
        ...
        from formulation_workbench.infrastructure.db.models import Base, ComponentModel, RecipeModel
    ...
    def test_infrastructure_logging_importable(self) -> None:
        from formulation_workbench.infrastructure.logging.setup import get_logger, setup_logging

        assert setup_logging is not None
        assert get_logger is not None

    def test_infrastructure_i18n_importable(self) -> None:
        from formulation_workbench.infrastructure.i18n import _, ngettext, setup_i18n
...
class TestSmokeInstantiation:
    ...
    def test_class_ranker_end_to_end(self) -> None:
        ...
        from formulation_workbench.domain.services.class_ranker import ClassRanker
        from formulation_workbench.domain.value_objects.citation import Citation
        ...
        assert ranking.recommended_class in list(ProductClass)
