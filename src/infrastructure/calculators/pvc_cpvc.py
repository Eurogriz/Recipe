...
class PvcCpvcCalculator:
    ...
    PIGMENT_KEYWORDS: tuple[str, ...] = (
        "titanium dioxide", "tio2", "calcium carbonate", "talc",
        "kaolin", "silica", "zinc oxide", "iron oxide",
        "carbon black", "phthalocyanine", "pigment",
    )

    BINDER_KEYWORDS: tuple[str, ...] = (
        "acrylic", "polyurethane", "alkyd", "epoxy", "silicone",
        "pva", "vinyl acetate", "binder", "emulsion", "dispersion",
    )
