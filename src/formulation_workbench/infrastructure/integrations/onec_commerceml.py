...
# Constructing XML uses the stdlib API (Element / SubElement / tostring).
# For *parsing* untrusted input we route through ``defusedxml``, which is a
# drop-in replacement that neutralises XXE and billion-laughs attacks.
from xml.etree import ElementTree as ET

from defusedxml.ElementTree import parse as _safe_parse
from defusedxml.minidom import parseString as _safe_parse_string  # noqa: N813
...
class OneCCommerceMlExporter:
    ...
    def _prettify(self, elem: ET.Element) -> bytes:
        ...
        reparsed = _safe_parse_string(rough_string)
